...
__all__ = ["DQNLoss", "MDQNLoss", "C51Loss", "get_estimator_device", "to_device"]
...
class MDQNLoss(NamedTuple):
    r""" Object returned by :attr:`get_munchausen_dqn_loss`. """
    loss: torch.Tensor
    qsa: torch.Tensor
    munchausen_target: torch.Tensor
    q_values: torch.Tensor
    q_targets: torch.Tensor
